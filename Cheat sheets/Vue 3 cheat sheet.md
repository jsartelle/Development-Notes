...
- for value types, use `ref`, which returns an object with a `.value` property
...
- allows you to destructure props with no additional code, and set default values easier when using [[#^04077c|type-based declaration]]
